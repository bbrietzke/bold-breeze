...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        page = urlopen("http://masterunitlist.info/Unit/Filter?Name=&HasBV=true&Rules=4").read().decode("utf-8")
...
for row in all_rows:
    ...
    print(name, master_unit_list_number, battle_value)
    if point_value is None:
        continue
    if date_introduced == 'PS' or 'ES' or 'Unknown':
